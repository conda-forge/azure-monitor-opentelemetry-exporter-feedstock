About azure-monitor-opentelemetry-exporter-feedstock
====================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/azure-monitor-opentelemetry-exporter-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/azure-monitor-opentelemetry-exporter-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add azure-monitor-opentelemetry-exporter
# for installing globally
pixi global install azure-monitor-opentelemetry-exporter
```
...
It is possible to list all of the versions of `azure-monitor-opentelemetry-exporter` available on your platform:
...
```
pixi search azure-monitor-opentelemetry-exporter --channel conda-forge
```
